...
Route::get('about', function () {
    return view('about.about'); })->name('about');
...
Route::delete('faqitem/{faqitem}', [FAQItemController::class, 'destroy'])->name('faqitem.destroy');
Route::get('faqitem/{faqitem}/edit', [FAQItemController::class, 'edit'])->name('faqitem.edit');
Route::put('faqitem/{faqitem}', [FAQItemController::class, 'update'])->name('faqitem.update');
...
Route::delete('category/destroy/{category}', [FAQCategoryController::class, 'destroy'])->name('category.destroy');
